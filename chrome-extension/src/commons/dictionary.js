...
export default {
  ...
  createWallet: {
    ...
    info:
      'The password will be used to lock the extension after you close the browser and to encrypt the wallet if you decide to export it... so don’t forget it!',
  ...
  walletInfo: {
    info: 'No Claims yet? For more informations visit our ',
    website: 'website',
  },
  welcome: {
  ...
  form: {
    ...
    info:
      'Please select a wallet to import. Note: if you have already a wallet will be overrided',
  },
  events: {
